		...
		if (fs.existsSync(configPath)) {
			try {
				...
				return {
					...
					max_thread_budget_usd: typeof parsed.max_thread_budget_usd === "number" ? parsed.max_thread_budget_usd : DEFAULTS.max_thread_budget_usd,
					max_session_budget_usd: typeof parsed.max_session_budget_usd === "number" ? parsed.max_session_budget_usd : DEFAULTS.max_session_budget_usd,
